    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group pb-4">
            ...
            <select class="form-select" name="brand" id="brand">
                <option value="1" <?= (isset($_POST['brand']) && $_POST['brand'] == "1") ? " selected" : "" ?>>Jinbei</option>
                <option value="2" <?= (isset($_POST['brand']) && $_POST['brand'] == "2") ? " selected" : "" ?>>Falcon</option>
                <option value="3" <?= (isset($_POST['brand']) && $_POST['brand'] == "3") ? " selected" : "" ?>>FST</option>
            </select>
        </div>
        <div class="form-group pb-4">
